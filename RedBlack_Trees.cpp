...
void RedBlack_Tree::restoreProperty(Node *node)
{
    ...
    else if (node != root && node->parent->color != BLACK)
    {
        if (node->parent->relation == LeftChild)
        {
            ...
            else if ((node->parent->parent->right != NULL && node->parent->parent->right->color == BLACK) || node->parent->parent->right == NULL)
            {
        ...
        else if (node->parent->relation == RightChild)
        {
            ...
            else if ((node->parent->parent->left != NULL && node->parent->parent->left->color == BLACK) || node->parent->parent->left == NULL)
            {

                if (node->relation == RightChild)
                {
